    ...
    function order_currency_dropdown($order_id){
        ...
        <?php
            ...
            wc_enqueue_js( "
                ...
                console.log(order_currency_current_value);
                jQuery('#dropdown_shop_order_currency').on('change', function(){

                    if(jQuery('#order_line_items .item').length){

                        alert('" . esc_js(__("Please remove current items from the order before changing the currency!", 'wpml-wcml')). "');
                        jQuery(this).val(order_currency_current_value);

                        return false;
                    }else{
                        order_currency_current_value = jQuery('#dropdown_shop_order_currency option:selected').val()
                    }
                    ...
                    jQuery.ajax({
                        ...
                        data: {
                            ...
                            currency: jQuery('#dropdown_shop_order_currency').val(),
